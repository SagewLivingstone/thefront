...
if USE_S3:
    ...
    AWS_STORAGE_BUCKET_NAME = config.get('aws', 'storage_bucket')
    AWS_S3_REGION = config.get('aws', 'region')
...
# HSTS Header
SECURE_HSTS_SECONDS = 30 # TODO: Edit later once https ensured (to 2_592_000, 30 days)
...
CSP_CONNECT_SRC = ["'self'", "ka-f.fontawesome.com"]
CSP_FONT_SRC = ["'self'", "ka-f.fontawesome.com"]
